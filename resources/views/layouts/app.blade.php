...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
    <div class="container-fluid">  
        <!-- Logo -->
        <a class="navbar-brand fw-bold text-primary" href="{{ url('/') }}">SPORTBOOKS</a>
        ...
        <div class="d-flex justify-content-end collapse navbar-collapse" id="navbarNav">
            ...
            <form class="me-2" action=" {{ route('search') }} " method="GET">
                <div class="search-box">
                    ...
                    <input class="form-control" type="text" name="keyword" placeholder="Tìm kiếm..." value=" {{ request('keyword') }}">
                </div>
            </form>

            @auth
                <div class="dropdown">
                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="account" data-bs-toggle="dropdown">
                        {{ Auth::user()->name }}
                    </button>
