...
@section('content')
    @if (Route::currentRouteName() === 'delivery.orders-m' ||
            Route::currentRouteName() === 'delivery.orders-cl' ||
            Route::currentRouteName() === 'delivery.orders-dcl' ||
            Route::currentRouteName() === 'delivery.orders-m.search')
    ...
    @if (Route::currentRouteName() === 'delivery.my-orders-detail')
        @include('deliverer.order-management-detail')
    @endif
    @if (Route::currentRouteName() === 'delivery.delivered-orders')
        @include('deliverer.my-delivered-orders')
    @endif
@endsection
