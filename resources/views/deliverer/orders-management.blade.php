    ...
    <div class="col-12 border border-dark border-1 rounded"
        ...
        <div class="row row-cols-auto px-3">
            @foreach ($orders as $order)
                ...
                <div class="col-2 text-center fw-bold align-self-center">
                    ${{ $order->total }}
                </div>
                <div class="col-3 text-center align-self-center">
                    @switch($order->status)
                ...
                <div class="col-2 text-center align-self-center">
                    <form action="{{ route('delivery.orders-cl', $order->id) }}" method="POST">
                        @csrf
                        <button class="btn btn-outline-primary">Nhận giao hàng</button>
                    </form>
